describe("Tonic Data Manager - Download JSON/Images using pattern", function() {
    it('test fetch for probe ds', function(done) {
        ...
        tonicDataManager.on('/base/data/probe/info.json', function(data, envelope) {
        ...
        var fetchURL = '/base/data/probe/info.json',
        ...
        testHelper.waitAndRun(function(d) {
            ...
            tonicDataManager.registerURL('images', '/base/data/probe/' + jsonDataModel.data[0].pattern, 'blob', 'image/png');
